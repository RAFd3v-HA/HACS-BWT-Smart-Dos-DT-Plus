...
class BwtStatusSensor(BaseEntity, SensorEntity):
    ...
    def native_value(self):
        code = self.coordinator.data["0201"].get(
            "devState"
        )
...
class BwtActiveStatesSensor(BaseEntity, SensorEntity):
    _attr_name = "Aktive Statusmeldungen"
    _attr_unique_id = "active_states"
...
class BwtTotalWaterSensor(BaseEntity, SensorEntity):
    _attr_name = "Aufbereitetes Wasser"
    _attr_unique_id = "total_water"
    ...
    def native_value(self):
        try:
            value_ml = self.coordinator.data["0503"][
                "flow"
            ]["1"]["totFlow"]
...
class BwtRemainingCapacitySensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Restvolumen"
    _attr_unique_id = "rem_capacity"
...
class BwtRemainingCapacityPercentSensor(
    ...
    _attr_name = "Restvolumen Prozent"
    _attr_unique_id = "rem_capacity_pct"
    ...
    def native_value(self):
        try:
            return self.coordinator.data["0402"]["1"][
                "remCapacityPct"
            ]
...
class BwtRemainingDaysSensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Resttage"
    _attr_unique_id = "rem_days"
...
class BwtPouchVolumeSensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Pouchvolumen"
    _attr_unique_id = "tot_cap"
    ...
    def native_value(self):
        try:
            return self.coordinator.data["0401"]["1"][
                "totCap"
            ]
...
class BwtExpirationDateSensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Ablaufdatum"
    _attr_unique_id = "exp_date"
...
class BwtProductionDateSensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Produktionsdatum"
    _attr_unique_id = "valid_date"
...
class BwtBatchNumberSensor(
    BaseEntity,
    SensorEntity,
):
    _attr_name = "Batchnummer"
    _attr_unique_id = "batch_nr"
